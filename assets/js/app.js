...
let apiUrl = "https://api.github.com/users/KevinPatel197";
...
$searchField.addEventListener("click", searchUser);
    ...
    fetchData(profileUrl, data => {
        ...
        $profileCard.innerHTML = `
            <figure class="${type === "User" ? "avatar-circle" : "avatar-rounded"} img-holder" style="--width: 280; --height: 280">
                <img src="${avatar_url}" height="280" width="280" alt="${username}" class="img-cover">
            </figure>
            ...
            ${company ?
                ...
                <li class="meta-item">
                    ...
                    <a href="#" target="_blank" class="meta-text">https://www.responscity.com/Responscity/Index.html</a>
                </li>
            ...
            <ul class="profile-stats">
                ...
                <li class="stats-item">
                    <span class="body">10</span> Repos
                </li>

                <li class="stats-item">
                    <span class="body">1</span> Follower
                </li>

                <li class="stats-item">
                    <span class="body">5</span> Following
                </li>

            </ul>

            <div class="footer">
                <p class="copyright">&copy; 2024 GitFinder</p>
            </div>  
        `;
